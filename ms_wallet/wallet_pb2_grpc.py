...
class WalletServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ValidateFunds = channel.unary_unary(
                '/wallet.WalletService/ValidateFunds',
...
def add_WalletServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ValidateFunds': grpc.unary_unary_rpc_method_handler(
                    servicer.ValidateFunds,
